...
func copy_environment_from_replay(replayer: Replayer) -> void:
	...
	var ref_viewport: SubViewport = EasyCompositorUtils.safe_get_viewport(replayer)
	...
	EasyCompositorUtils.set_active_environment(new_camera, EasyCompositorUtils.get_active_environment(replayer))
	
	EasyCompositorUtils.set_active_camera_attributes(new_camera, EasyCompositorUtils.get_active_camera_attributes(replayer))
	...
	EasyCompositorUtils.set_active_compositor(new_camera, null)
